...
这是 \bitthesis{} 的示例文档，基本上覆盖了模板中所有格式的设置。建议大家在使用模
板之前，除了阅读《\bitthesis{}用户手册》，这个示例文档也最好能看一看。
...
xfig    \begin{tabular*}{\linewidth}{lp{10cm}}
      \toprule[1.5pt]
      {\heiti 文件名} & {\heiti 描述} \\\midrule[1pt]
      bitthesis.ins & \LaTeX{} 安装文件，docstrip\footnote{表格中的脚注} \\
      bitthesis.dtx & 所有的一切都在这里面\footnote{再来一个}。\\
      bitthesis.cls & 模板类文件。\\
      bitthesis.cfg & 模板配置文。cls 和 cfg 由前两个文件生成。\\
      bitbib.bst    & 参考文献 Bibtex 样式文件。\\
      bittils.sty   & 常用的包和命令写在这里，减轻主文件的负担。\\
      \bottomrule[1.5pt]
    \end{tabular*}
  \end{minipage}
\end{table}
...
\begin{table}[htbp]
 ...
 \multirow{2}*{\diagbox[width=5em]{x}{y}}  & \multicolumn{2}{c|}{First Half} & \multicolumn{2}{c|}{Second Half}\\\cline{2-5}
    ...
    \end{tabularx}\\[2pt]
    \footnotesize 注：数据来源《\bitthesis{} 使用手册》。\\
    *：东部\\
    **：西部
  \end{minipage}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}[c]{|c|m{0.8in}|c|c|c|c|c|}\hline
    ...
    \multirow{2}{1in}{Xue} & Rui  & Ni &\multicolumn{4}{c|}{\multirow{2}*{\bitthesis}}\\\cline{2-3}
...
本模板推荐使用 BIB\TeX，样式文件为 bitbib.bst，基本符合学校的参考文献格式（如专利
